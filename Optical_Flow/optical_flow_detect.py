    ...
    while end_flag:
        ...
        if step % 10 == 0:
            ...
            if total_velocity > THRESHOLD:
                state = "Something Moving in the video"
            else:
                state = "Nothing Moving in the video"
            temp_velos = []
        else:
            pass
        ...
        for i, (next_point, prev_point) in enumerate(zip(good_next, good_prev)):
            ...
            # print current existence of movement in the video
            frame = cv2.putText(frame, state, (100,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0,0,0), 3, cv2.LINE_AA)
...
if __name__ == '__main__':
    ...
    avgVels = optical_flow_detect(video=cap)
    # finish
